  ...
  if (!consent) {
    return (
      <div className="relative flex aspect-[4/3] w-full flex-col items-center justify-center gap-4 rounded-3xl bg-mist p-8 text-center">
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" className="text-slate">
          <path
        ...
        <button
          ...
          className="rounded-full bg-slate px-6 py-3 text-sm font-semibold text-paper transition hover:bg-ink"
        >
